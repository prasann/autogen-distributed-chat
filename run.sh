...
run_in_venv distributed_group_chat:0.0 "python src/run_host.py" C-m
run_in_venv distributed_group_chat:0.1 "chainlit run src/run_ui.py --port 8001" C-m
run_in_venv distributed_group_chat:0.3 "python src/run_writer_agent.py" C-m
run_in_venv distributed_group_chat:0.4 "python src/run_editor_agent.py" C-m
run_in_venv distributed_group_chat:0.2 "python src/run_group_chat_manager.py" C-m
